...
void loop() {
  ...
  if (stringComplete) {
    ...
    switch (cmd) {
      ...
      case 12:
        {
            Serial.println("12"); // *** SEND IMMEDIATE ACK FOR CMD 12 ***
            outputString = "";   // Clear outputString for the final response
          ...
          if (motorPower >= (-100) && motorPower <= 100) {
            outputString += "12 Motor power set to: ";
      ...
      case 16:
        {
            Serial.println("16"); // *** SEND IMMEDIATE ACK FOR CMD 16 ***
          outputString = "";   // Clear outputString for the final response
      ...
      case 17:
        {
            Serial.println("17"); // *** SEND IMMEDIATE ACK FOR CMD 17 ***
          outputString = "";   // Clear outputString for the final response
      ...
      default:
        {
          ...
          outputString += cmd; // Echo back the invalid command received
